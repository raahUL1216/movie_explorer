  ...
  return (
    <div className="filters">
      <div className="search-wrapper search-input-wrapper">
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" className="search-input-icon" tabIndex={0} data-testid="search-input-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
